...
const VMIX_TRIGGERS = [
    ...
    { key: 'u', graphic: 'Course underlay', desc: 'KRI only — procedural Karāpiro 2 km course (10 lanes × 10 m, OOB, buoys, 250 m marks); sim 4 m/s · lane draw from live race · 1–9 / 0 assign Leader highlight on a lane · ?deviceId= CrewSight · o to fade out. Ged CV course (crew tags + leader line): vmix-ged-cv-course.html?cvLaptop=http://<cv>:8790. Laptop-only: CV cv-drone-course-overlay.html.' },
