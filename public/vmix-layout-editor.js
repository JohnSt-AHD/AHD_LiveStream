...
(function (global) {
    const LAYOUT_IDS = {
        ...
        draw: [
            { id: 'draw-head', label: 'Draw — header block (all)', posMode: 'transform' },
            { id: 'draw-kicker', label: 'Draw — “Start list” kicker', target: 'draw-kicker' },
            { id: 'draw-title', label: 'Draw — event title', target: 'draw-title' },
            { id: 'draw-meta', label: 'Draw — race / round line', target: 'draw-meta' },
            { id: 'draw-body', label: 'Draw — title + columns + rows block', posMode: 'transform' },
        ...
        results: [
            { id: 'results-head', label: 'Results — header block (all)', posMode: 'transform' },
            { id: 'results-kicker', label: 'Results — kicker', target: 'results-kicker' },
            { id: 'results-title', label: 'Results — event title', target: 'results-title' },
            { id: 'results-meta', label: 'Results — race line', target: 'results-meta' },
            { id: 'results-body', label: 'Results — title + columns + rows block', posMode: 'transform' },
        ...
        schedule: [
            { id: 'schedule-head', label: 'Schedule — header block (all)', posMode: 'transform' },
            { id: 'schedule-kicker', label: 'Schedule — kicker', target: 'schedule-kicker' },
            { id: 'schedule-title', label: 'Schedule — title', target: 'schedule-title' },
            { id: 'schedule-meta', label: 'Schedule — current race line', target: 'schedule-meta' },
            { id: 'schedule-body', label: 'Schedule — title + columns + rows block', posMode: 'transform' },
