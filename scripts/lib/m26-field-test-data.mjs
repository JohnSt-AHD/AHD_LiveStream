...
export const M26_FIELD_TEST = {
  ...
  battery: {
    ...
    startTimeNz: '06:45',
    endTimeNz: '17:01',
    endIso: '2026-06-14T05:01:21.697Z',
    snapshotPct: 64,
    elapsedH: 10.3,
    dropPct: 32,
    drainPerH: 3.1,
    ...
    dataUsageMb: 36,
    gpsRateHz: 1,
    /** Recorder history over full battery session (not live-device snapshot). */
    sessionTotalSamples: 30894,
    sessionActiveRateHz: 1.0,
    sessionAvgRateHz: 0.77,
    sessionActiveMedianGapSec: 1.0,
    sessionIdleGapsOver60s: 15,
